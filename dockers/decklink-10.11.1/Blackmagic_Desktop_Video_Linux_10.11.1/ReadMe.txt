...
What's New in Desktop Video 10.11.1
----------------------------------

New features for Cintel Film Scanner:

 * Add support for Linux.
 * Add support for the Cintel Film Scanner 2.
 * Add support for High Dynamic Range gates.
 * Fix text in perforation area interfering with vertical stabilization.
 * Improve horizontal stabilization preventing jumping.
 * Fix potential for duplicate KeyKodes in 16mm.
 * Fix potential corrupt image/crash during 'Calibrate'.
...
* The package installed, but the driver was not loaded
    ...
    Try the following command:
     ...
     blackmagic, 10.1.2, 3.5.0-27-generic, x86_64: <STATUS>
    ...
    determine the problem.
     ...
     # sudo dkms build -m blackmagic[-io] -v 10.1.2
    ...
    the output to determine the problem.
     ...
     # sudo dkms install -m blackmagic[-io] -v 10.1.2 --all
...
© 2018 Blackmagic Design Pty. Ltd. All rights reserved. Blackmagic Design, Blackmagic, DeckLink, Multibridge, HDLink, Videohub, and "Leading the creative video revolution" are trademarks of Blackmagic Design Pty. Ltd., registered in the U.S.A and other countries.
