...
%filter_provides_in %{_libdir}/blackmagic/DesktopVideo/.*\.so.*$ 
...
#
Name:          desktopvideo
Summary:       Blackmagic Design Desktop Video 10.11.1 - Driver and Firmware Update Utility
Version:       10.11.1
Release:       a4
License:       Proprietary
...
if [ "%{_lib}" != lib ]; then
    for FILE in $RPM_BUILD_ROOT/usr/src/*/dkms.conf $RPM_BUILD_ROOT/etc/udev/rules.d/55-blackmagic.rules $RPM_BUILD_ROOT/etc//init/DesktopVideoHelper.conf $RPM_BUILD_ROOT/etc/init.d/DesktopVideoHelper $RPM_BUILD_ROOT/usr/lib/systemd/system/DesktopVideoHelper.service; do
...
ln -sf ../%{_lib}/blackmagic/DesktopVideo/BlackmagicDesktopVideoSetup $RPM_BUILD_ROOT/usr/bin/BlackmagicDesktopVideoSetup
ln -sf ../%{_lib}/blackmagic/DesktopVideo/BlackmagicFirmwareUpdater $RPM_BUILD_ROOT/usr/bin/BlackmagicFirmwareUpdater
ln -sf ../%{_lib}/blackmagic/DesktopVideo/DesktopVideoUpdater $RPM_BUILD_ROOT/usr/bin/DesktopVideoUpdater
ln -sf ../%{_lib}/blackmagic/DesktopVideo/BlackmagicFirmwareUpdaterGui $RPM_BUILD_ROOT/usr/bin/BlackmagicFirmwareUpdaterGui
...
ensure_config_perms()
{
	...
	if [ -e "/etc/blackmagic" ]; then
		chmod 777 /etc/blackmagic
	fi
...
%{_usrsrc}/*-10.11.1a4/*
%{_libdir}/libDeckLink*API.so
%{_libdir}/blackmagic/DesktopVideo/BlackmagicPreferencesStartup
%{_libdir}/blackmagic/DesktopVideo/BlackmagicFirmwareUpdater
%{_libdir}/blackmagic/DesktopVideo/DesktopVideoHelper
%{_libdir}/blackmagic/DesktopVideo/blackmagic-loader
%{_libdir}/blackmagic/DesktopVideo/libc++.so.1
%{_libdir}/blackmagic/DesktopVideo/libc++abi.so.1
%{_libdir}/blackmagic/DesktopVideo/libgcc_s.so.1
...
%package scanner
Summary:   Blackmagic Design Desktop Video 10.11.1 - Cintel Scanner driver
Group:     Applications/Multimedia
Requires:  desktopvideo >= 10.11.1

%files scanner
%{_libdir}/libScannerAPI.so
%{_docdir}/desktopvideo-scanner

%description scanner
The runtime library for controlling a Cintel film scanner.

%package gui
Summary:   Blackmagic Design Desktop Video 10.11.1 - GUI Utilities
Group:     Applications/Multimedia
Requires:  desktopvideo >= 10.11.1, hicolor-icon-theme
Conflicts: DeckLink, Multibridge, Intensity
...
%{_bindir}/BlackmagicDesktopVideoSetup
%{_bindir}/BlackmagicFirmwareUpdaterGui
%{_bindir}/DesktopVideoUpdater
%{_datadir}/applications/*
%{_datadir}/icons/hicolor/*/apps/*
%{_libdir}/blackmagic/DesktopVideo/BlackmagicDesktopVideoSetup
%{_libdir}/blackmagic/DesktopVideo/BlackmagicFirmwareUpdaterGui
%{_libdir}/blackmagic/DesktopVideo/DesktopVideoUpdater
%{_libdir}/blackmagic/DesktopVideo/libusb-1.0.so.0
%{_libdir}/blackmagic/DesktopVideo/Firmware/*
%{_libdir}/blackmagic/DesktopVideo/libQt5*
%{_libdir}/blackmagic/DesktopVideo/plugins/*
%{_libdir}/blackmagic/DesktopVideo/qt.conf
%{_mandir}/man1/BlackmagicFirmwareUpdaterGui.1.gz
%{_mandir}/man1/BlackmagicDesktopVideoSetup.1.gz
%{_mandir}/man1/DesktopVideoUpdater.1.gz
 ...
 * BlackmagicDesktopVideoSetup: Allows configuration of your DesktopVideo device
 * BlackmagicFirmwareUpdaterGui: Checks for and performs any firmware updates
   required
